        ...
        <div className="grid gap-6 mb-8">
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <div className="flex items-center">
                  <div className="text-5xl font-bold text-blue-600">{profileData.rank}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-green-50 p-6 rounded-lg shadow-md h-40 flex flex-col justify-center">
              ...
              <div className="text-5xl font-bold text-green-600">{profileData.wins}</div>
            </div>
            ...
            <div className="bg-yellow-50 p-6 rounded-lg shadow-md h-40 flex flex-col justify-center">
              ...
              <div className="text-5xl font-bold text-yellow-600">{profileData.winStreak}</div>
            </div>
